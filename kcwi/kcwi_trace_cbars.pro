; $Id: kcwi_trace_cbars.pro | Fri Apr 24 12:15:57 2015 -0700 | Don Neill  $
;
...
kcwi_print_info,ppar,pre,'Found 60 peaks'
;
...
if do_plots ge 1 then begin
	oplot,!x.crange,[kgeom.trimy0,kgeom.trimy0],thick=3
	oplot,!x.crange,[kgeom.trimy1,kgeom.trimy1],thick=3
endif
print,pre+': Info - Done.'
;
; continue?

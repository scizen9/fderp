; $Id: kcwi_ppar__define.pro | Thu Apr 23 11:31:25 2015 -0700 | Don Neill  $
;
...
; Slice profile processing
	slicex0:19, $		; safe lower spatial limit for slices
	slicex1:172, $		; safe upper spatial limit for slices
